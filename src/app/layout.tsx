...
const clerkAppearance = {
  ...
  elements: {
    ...
    badge: { color: '#d4d4d8', backgroundColor: '#303030', border: '1px solid #484848' },
    badgePrimary: { color: '#d4d4d8', backgroundColor: '#303030', border: '1px solid #484848' },
    tableHead: { color: '#a1a1aa' },
    identityPreviewText: { color: '#ffffff' },
    formattedEmailAddress: { color: '#ffffff' },
    userEmailAddress: { color: '#ffffff' },
    formButtonPrimary: { backgroundColor: '#7c3aed', color: '#ffffff' },
    otpCodeFieldInput: { backgroundColor: '#1e1e1e', borderColor: '#444444', color: '#ffffff' },
